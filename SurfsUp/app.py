...
def precipitation():
    ...
    date_one_year_from_the_last_date = dt.date(twelve_months.year, twelve_months.month, twelve_months.day)

    results= session.query(Measurement.date, Measurement.prcp).filter(Measurement.date >= date_one_year_from_the_last_date)\
